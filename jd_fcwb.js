...
cron 40 12,16 * * * https://raw.githubusercontent.com/sigou006/jd/main/jd_fcwb.js
支持助力码(第一个ck依然助力作者)
fcwbinviteCode
fcwbinviter
* * */
...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('https://raw.githubusercontent.com/sigou006/helpRepository/main/fcwb.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/sigou006/helpRepository@main/fcwb.json');}catch (e) {}
        if(!res){res = [];}
    }
    let res2 = [];
    try{res2 = await getAuthorShareCode('https://raw.githubusercontent.com/sigou006/helpRepository/main/json/shareCodes/fcwb.json');}catch (e) {}
    if(!res2){
        try{res2 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/sigou006/helpRepository@main/json/shareCodes/fcwb.json');}catch (e) {}
        if(!res2){res2 = [];}
    }
    res = [...res,...res2]
    if(res.length > 0){
