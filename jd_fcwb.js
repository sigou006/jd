...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('https://raw.githubusercontent.com/sigou006/helpRepository/main/json/jxfcwb.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/sigou006/helpRepository@main/json/jxfcwb.json');}catch (e) {}
        if(!res){res = [];}
    }
    if(res.length > 0){
